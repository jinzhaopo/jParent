...
public class FileHelpers {
	...
	//// String[] imageExtensionArray =
	// SettingUtils.get().getUploadImageExtensions();
	//// if (!fileName.trim().equals("") && fileName.length() > 0) {
	//// String exrtension = getFileExt(fileName);
	//// return ArrayUtils.contains(imageExtensionArray, exrtension);
	//// } else {
	//// return false;
	//// }
	// }
