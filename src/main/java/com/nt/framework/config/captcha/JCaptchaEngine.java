package com.nt.framework.config.captcha;
...
/**
 * 
 * @ClassName: JCaptchaEngine
 * @Description: 生成验证码图片
 * @author: zhaopo
 * @date: 2016年11月4日 下午1:38:44
 */
public class JCaptchaEngine extends ListImageCaptchaEngine {
	...
	protected void buildInitialFactories() {
		// RandomFontGenerator randomfontgenerator = new
		// RandomFontGenerator(MIN_FONT_SIZE, MAX_FONT_SIZE, RANDOM_FONT);
		// FileReaderRandomBackgroundGenerator
		// filereaderrandombackgroundgenerator =
		// new FileReaderRandomBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT,
		// new ClassPathResource("/net/shopxx/captcha/").getPath());
		// DecoratedRandomTextPaster decoratedrandomtextpaster =
		// new DecoratedRandomTextPaster(MIN_WORD_LENGTH, MAX_WORD_LENGTH,
		// new RandomListColorGenerator(RANDOM_COLOR), new TextDecorator[0]);
		// addFactory(new GimpyFactory(new RandomWordGenerator(RANDOM_WORD),
